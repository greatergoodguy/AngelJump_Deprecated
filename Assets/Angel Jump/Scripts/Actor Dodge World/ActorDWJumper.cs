...
public class ActorDWJumper : ActorDW_BaseJumper {
	
	private static readonly string TAG = typeof(ActorDWJumper).Name;
	...
	void Start () {
		handler = new ActorDWJumper.Handler(this);
	...
	public class Handler {
		...
		ActorDWJumper jumper;

		public Handler(ActorDWJumper jumper) {
			this.jumper = jumper;
		}
